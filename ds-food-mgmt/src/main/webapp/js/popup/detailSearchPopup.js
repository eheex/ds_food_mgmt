	...
	_drawChoiceArea:function(choiceData){
		...
		$.each(choiceData, function(key){
			$.each(choiceData[key], function(){
				...
				if(key == "allergyCds"){
					$('<li><input type="checkbox" id="'+_code+'" name="'+_code+'" /><label for="'+_code+'"><div><i></i></div>'+_codeNm+'</label></li>').data("cData",this).appendTo($("div._allergy ul"));
				}else if(key == "notAddCds"){
					$('<li><input type="checkbox" id="'+_code+'" name="'+_code+'" /><label for="'+_code+'"><div><i></i></div>'+_codeNm+'</label></li>').data("cData",this).appendTo($("div._noadd ul"));
				}else if(key == "certifyCds"){
					$('<li><input type="checkbox" id="'+_code+'" name="'+_code+'" /><label for="'+_code+'"><div><i></i></div>'+_codeNm+'</label></li>').data("cData",this).appendTo($("div._certify ul"));
				}
			});
		});
	},
